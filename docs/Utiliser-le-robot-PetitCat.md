...
This page explains how to test the [PetitCat](https://github.com/OlivierGeorgeon/osoyoo/wiki) robot using the [test_remote_control_robot.py](https://github.com/OlivierGeorgeon/TestROS/blob/master/PetitCatTester.py) file. 
Alternatively, you can use the [test_remote_control_robot.ipynb](https://github.com/OlivierGeorgeon/TestROS/blob/master/PetitCatTester.ippynb) notebook.
...
Clone this project or download the file [test_remote_control_robot.py](https://github.com/OlivierGeorgeon/TestROS/blob/master/PetitCatTester.py).
...
To try the optional fields, you must modify `PetitCatTester.py`.
